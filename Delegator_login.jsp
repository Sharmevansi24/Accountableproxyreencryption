            ...
            <div class="content-4-main py-5">
                <div class="container">
                    <div class="content-info-in row">
                        <div class="col-lg-6">
                            <img src="img/login.jpg" width="450" height="350" />
                        </div>
                        <div class="col-lg-6">
                            <h3 class="title-big text-center">Delegator Login</h3><br><br>
                            <form action="delegator_signin.jsp" method="post">
                                ...
                                <div class="text-lg-left text-center">
                                    ...
                                    <a href="delegator_signup.jsp" class="btn btn-style btn-primary">Register!</a>
                                </div>
                            </form>
                        </div>
                    </div>
