            ...
            <div class="content-4-main py-5">
                <div class="container">
                    <div class="content-info-in row">
                        <div class="col-lg-6">
                            <br><br><br>
                            <img src="img/upload.png" width="450" height="350" />
                        </div>
                        <div class="col-lg-6">
                            <h3 class="title-big text-center">Upload File</h3><br><br>
                            <form action="upload" method="post" enctype="multipart/form-data">
                                ...
                                <div class="text-lg-left text-center">
                                    <button type="submit" class="btn btn-style btn-primary">Upload</button>
                                </div>
                            </form>
                        </div>
                    </div>
