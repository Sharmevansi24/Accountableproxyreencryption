            ...
            <div class="content-4-main py-5">
                <div class="container py-lg-4">
                    <div class="content-info-in row">
                        <div class="col-lg-12">
                            <h3 class="title-big text-center">Request File</h3><br><br>
                            <table id="customers">
                                <tr>
                                    <th>File ID</th>
                                    <th>File Name</th>
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("SELECT * FROM do_files WHERE filekeyword LIKE '%" + keyword + "%' OR filename LIKE '%" + keyword + "%' ");
                                        if (rs.next()) {
                                            rs.previous();
                                            while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td><a class="btn btn-info" href="user_request.jsp?fid=<%=rs.getString("id")%>">Request</a></td>
                                </tr>
                                <%                                        }
                                        } else {
