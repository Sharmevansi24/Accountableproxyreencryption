    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (status) {
                ...
                int i = st.executeUpdate("insert into do_files(doid, doname, data_file, dkey, time, filename, data, filekeyword, reencrypt_file, rdkey, hashcode, hashcode1, enc_time)values('" + doid + "','" + doname + "','" + encryptedtext + "','" + Dkey + "','" + time + "','" + file.getName() + "','" + sb.toString() + "', '" + filekeyword + "', '" + encryptedtext1 + "', '" + RDkey + "','" + hash2 + "','" + hash2 + "','"+ encryptTime +"')");
                if (i != 0) {
