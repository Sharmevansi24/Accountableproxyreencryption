            ...
            <div class="content-4-main py-5">
                <div class="container">
                    <div class="content-info-in row">
                        ...
                        %>
                        <div class="col-lg-6">
                            <h3 class="title-big text-center">Update File</h3><br><br>
                            <form action="update_file1.jsp" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" style=" height: 170px;resize: none" name="update_file"><%=rs.getString("reencrypt_file")%></textarea>  <br>         
                                </div>
                                <div class="text-lg-left text-center">
                                    <button type="submit" class="btn btn-style btn-success">Update</button>
                                </div>
                            </form>
                        </div>
                        <%}
