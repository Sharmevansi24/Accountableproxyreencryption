            ...
            <div class="content-4-main py-5">
                <div class="container py-lg-4">
                    <div class="content-info-in row">
                        <div class="col-lg-12">
                            <h3 class="title-big text-center">My Files</h3><br><br>
                            <table id="customers">
                                <tr>
                                    <th>File ID</th>
                                    <th>File Name</th>
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from audit_request where doid  ='" + doid + "' AND status = 'Verified' ");
                                        while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td><a href="audit_verify2.jsp?&fid=<%=rs.getString("fid")%>&fname=<%=rs.getString("filename")%>&hash=<%=rs.getString("hashcode")%>" class="btn btn-success">Verify</a></td>
                                </tr>
                                <%                                        }
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
