            ...
            <div class="content-4-main py-5">
                <div class="container">
                    <div class="content-info-in row">
                        <div class="col-lg-6">
                            <img src="img/cloudlogin.jpg" width="450" height="350" />
                        </div>
                        <div class="col-lg-6">
                            <h3 class="title-big text-center">Cloud Login</h3><br><br>
                            <form action="cloud" method="post">
                                <div class="form-group">
                                    <label>Email :</label>
                                    <input type="text" name="name" class="form-control" placeholder="Enter Your Email" required="required">
                                </div>
                                <div class="form-group">
