            ...
            <div class="content-4-main py-5">
                <div class="container">
                    <div class="content-info-in row">
                        <div class="col-lg-6">
                            <img src="img/req.png" width="450" height="350" />
                        </div>
                         <%
                        ...
                        <div class="col-lg-6">
                            ...
                            <form action="view_file.jsp" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rdkey" class="form-control" placeholder="Enter Re-Decryption Key" autocomplete="off" required="required">
                                </div>
                                <div class="text-lg-left text-center">
                                    <button type="submit" class="btn btn-style btn-info">Verify</button>
                                </div>
                            </form>
                        </div>
                    </div>
